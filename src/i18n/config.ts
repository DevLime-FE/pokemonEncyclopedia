...
const resources = {
  ko: {
    translation: {
      ...
      "What? {{name}} is evolving!": "오잉? {{name}}의 상태가!?",
      "Congratulations! {{name}} evolved into {{evolvedName}}!": "축하합니다! {{name}}은(는) {{evolvedName}}(으)로 진화했습니다!",
      "{{name}} flinched and couldn't move!": "{{name}}은(는) 풀죽어서 움직일 수 없다!",
      "{{name}} thawed out!": "{{name}}의 얼음이 녹았다!",
      "{{name}} is frozen solid!": "{{name}}은(는) 꽁꽁 얼어붙었다!",
      "{{name}} woke up!": "{{name}}은(는) 눈을 떴다!",
      "{{name}} is fast asleep.": "{{name}}은(는) 쿨쿨 잠들어 있다.",
      "{{name}} is paralyzed! It can't move!": "{{name}}은(는) 마비되어 기술을 낼 수 없다!",
      "{{name}} is paralyzed! It may be unable to move!": "{{name}}은(는) 마비되어 기술을 낼 수 없을 때가 있다!",
      "{{name}} is confused!": "{{name}}은(는) 혼란에 빠져있다!",
      "{{name}} snapped out of confusion!": "{{name}}의 혼란이 풀렸다!",
      "It hurt itself in its confusion!": "영문도 모른 채 자신을 공격했다!",
      "{{name}} is immobilized by love!": "{{name}}은(는) 헤롱헤롱해서 기술을 낼 수 없다!",
      "{{name}} was burned!": "{{name}}은(는) 화상을 입었다!",
      "{{name}} was poisoned!": "{{name}}은(는) 독에 걸렸다!",
      "{{name}} was badly poisoned!": "{{name}}은(는) 맹독에 걸렸다!",
      "{{name}} fell asleep!": "{{name}}은(는) 잠들어버렸다!",
      "{{name}} became confused!": "{{name}}은(는) 혼란에 빠졌다!",
      "{{name}} is already confused!": "{{name}}은(는) 이미 혼란에 빠져있다!",
      "{{name}} fell in love!": "{{name}}은(는) 헤롱헤롱해졌다!",
      "{{name}} is already in love!": "{{name}}은(는) 이미 헤롱헤롱하다!",
      "{{name}} cut its own HP and laid a curse on {{target}}!": "{{name}}은(는) 자신의 체력을 깎아 {{target}}에게 저주를 걸었다!",
      "It doesn't affect {{name}}...": "{{name}}에게는 효과가 없는 것 같다...",
      "{{name}} is already affected by a status condition!": "{{name}}은(는) 이미 상태이상에 걸려있다!",
      "But it failed!": "그러나 실패했다!",
      "{{name}} is hurt by its burn!": "{{name}}은(는) 화상 데미지를 입었다!",
